...
const TESTS = [
  ...
  },
  {
    ...
    gradient: 'linear-gradient(145deg, #b45309 0%, #d97706 100%)',
    count: '89,445',
    time: '1분',
  ...
  },
  {
    ...
    emoji: '🔮',
    category: '운세',
    desc: '생년월일 사주 분석으로 보는 정밀 신년 운세! 2025~2028년 선택 가능 — 재물·애정·건강·직업 맞춤 분석',
  ...
  },
  {
    ...
    gradient: 'linear-gradient(145deg, #0d5b8a 0%, #0891b2 100%)',
    count: '67,445',
    time: '2분',
